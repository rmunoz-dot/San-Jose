...
const AdminDocuments: React.FC = () => {
    ...
    const [category, setCategory] = useState('Reglamentos Institucionales');
    ...
    const fetchDocuments = async () => {
        ...
        const nonUtpDocs = fetchedDocs.filter(doc => !doc.category?.includes('UTP'));
        setDocuments(nonUtpDocs);
        setIsLoading(false);
    };
        ...
        <div className="min-h-screen bg-gray-50 py-24 relative">
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="mb-10 text-center">
                    <h1 className="text-3xl font-bold font-heading text-school-navy">Panel de Administración de Documentos</h1>
                    <p className="text-gray-600 mt-2">Sube y organiza los documentos institucionales generales.</p>
                </div>

                <AdminTabBar setRunTour={setRunTour} handleLogout={handleLogout} />
                <AdminTour run={runTour} setRun={setRunTour} type="documents" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        >
                                            <option value="Reglamentos Institucionales">Reglamentos Institucionales</option>
                                            <option value="Plan de Formación Ciudadana">Plan de Formación Ciudadana</option>
